...
# change the type pf data by as.type(). You should mention your desired datatype
  ...
  setwd("C:/Users/elham/OneDrive/Desktop")# to set the working directory. 
...
# Reading and Writing data to and from in R
  ...
  data<- read.csv("C:\\Users\\elham\\OneDrive\\Desktop\\alldata.csv")# (using "\\" not "\") 
  ...
  write.csv(data,"C:\\Users\\elham\\OneDrive\\Desktop\\alldata_new.csv") # *ERROR* That is a sample. You do not have the file named "data".
  write.table(data,"C:\\Users\\elham\\OneDrive\\Desktop\\alldata_new2.csv") # *ERROR* That is a sample. You do not have the file named "data".
